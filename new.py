...
ai_client = OpenAI(
    api_key="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"
)
def page_ai_coach():
    st.header("AI코치와 대화하기")
    if "messages" not in st.session_state:
        st.session_state.messages = [
            {"role": "system", "content":"ㅓㄴ는 사용자의 할 일 목록과 달성정도를 분석하여 조연하는 열정적인 코치야, 사용자가 더 멋진 삶을할 수 이쑈도록 멸화학 조연과 응원해줘. "}
        ]
